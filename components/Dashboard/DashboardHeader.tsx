    ...
    <header className="w-full bg-brand-dark/50 backdrop-blur-md border-b border-white/5 py-4">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-1 px-2 py-0.5 rounded-md bg-gradient-to-r from-brand-red/20 to-brand-red/10 border border-brand-red/20">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link
            href="/insights"
            className="group relative flex items-center gap-2 px-4 py-2 shadow-lg shadow-red-600/50 rounded-full overflow-hidden transition-all duration-300 hover:shadow-[0_0_20px_rgba(215,35,35,0.3)]"
          >
          ...
          <Link
            href="/settings"
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/5 transition-all text-gray-300 hover:text-white"
          >
